/*
 * Created by JFormDesigner on Tue Dec 10 16:00:32 CST 2024
 */
...
public class RoomTypeAddUi extends JFrame {
    ...
    private void save(ActionEvent e) {
        ...
        if(i>0){
           /* table = new JTable(new DefaultTableModel(
                    new Object[][]{},
                    new String[]{"ID", "房型", "单价", "押金", "床位数", "备注"}
            ));*/
            DefaultTableModel model =  (DefaultTableModel) table.getModel();
            Object[][] objects=service.selectList();
            model.setDataVector(objects,new String[]{"id","房型","单价","押金","床位数","备注"});
            table.updateUI();
            JOptionPane.showMessageDialog(this, "保存成功","提示消息",JOptionPane.INFORMATION_MESSAGE);
            goBack(e);
        }
    ...
    private void initComponents() {
        ...
        panel1.setBounds(155, 110, 535, 425);
        ...
        contentPane.setPreferredSize(new Dimension(820, 615));
        pack();
